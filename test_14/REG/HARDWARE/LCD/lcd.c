...
{
	//**********************************************************************************************
	if(lcdltdc.pwidth!=0)LTDC_Switch(1);//开启LCD  RGB屏
	//**********************************************************************************************
...
{	   
	//**********************************************************************************************
	if(lcdltdc.pwidth!=0)LTDC_Switch(0);//关闭LCD	RGB屏
	//**********************************************************************************************
...
void LCD_Scan_Dir(u8 dir)
{
	...
	if(lcddev.id==0x9341||lcddev.id==0X5310||lcddev.id==0X5510||lcddev.id==0X1963||lcddev.id==0x7789)//9341/5310/5510/1963/77789,特殊处理
	{
		switch(dir)
		{
...
{ 	 
	...
	if(lcddev.id==0X9341||lcddev.id==0X7789||lcddev.id==0X5310||lcddev.id==0X5510||lcddev.id==0X1963||lcddev.id==0X7789)//如果是这几个IC,则设置WR时序为最快
	{
		...
		FMC_Bank1E->BWTR[0]|=5<<0;	 	//地址建立时间(ADDSET)为4个HCLK =18.4ns  	 
		FMC_Bank1E->BWTR[0]|=5<<8; 		//数据保存时间(DATAST)为4.6ns*4个HCLK=18.4ns
	} 
